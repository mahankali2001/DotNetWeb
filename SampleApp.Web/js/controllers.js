...
//ngdemo.controller('baseController', ['$scope', '$location', '$translate', 'ngdemo.services', 'sharedScope', 'routeParams', function ($scope, $location, $translate, demoService, sharedScope, $routeParams) {
...
//    routeProvider.when('/users/:id/', { templateUrl: '../../../../users/'});
//    $location.path('../../../../users/');
